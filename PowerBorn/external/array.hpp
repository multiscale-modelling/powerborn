/* 
 *
 * For Licensing information about this file, please consult the boost library Licenses.
 * This License only covers this single file explicitly.
 *
 * The following code declares class array,
 * an STL container (as wrapper) for arrays of constant size.
 *
 * See http://www.boost.org/libs/array/
